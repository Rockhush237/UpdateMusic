...
from Rockhush.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAECwiFk__Kpbl2QEC2ghHQDAAGgovpI-2wAAhUMAAKsZkBW-srhBRkseUcwBA")
