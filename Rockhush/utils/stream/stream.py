...
from Rockhush.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Rockhush.utils.exceptions import AssistantErr
from Rockhush.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from Rockhush.utils.inline.playlist import close_markup
from Rockhush.utils.pastebin import Anonbin
from Rockhush.utils.stream.queue import put_queue, put_queue_index
from Rockhush.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Rock.force_stop_stream(chat_id)
